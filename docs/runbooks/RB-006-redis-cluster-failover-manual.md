# Operational Runbook: Redis Sentinel / Cluster Primary Failover Procedures
**Runbook Identifier**: RB-006-redis-cluster-failover-manual
...
This runbook governs emergency remediation procedures for: Redis Sentinel / Cluster Primary Failover Procedures.
