# Operational Runbook: Mass Geofence Exit Flap Storm Incident Resolution
**Runbook Identifier**: RB-009-geofence-alert-storm-suppression
...
This runbook governs emergency remediation procedures for: Mass Geofence Exit Flap Storm Incident Resolution.
