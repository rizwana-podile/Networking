# Operational Runbook: GPS Telemetry Spoofing & Tamper Incident Forensics
**Runbook Identifier**: RB-002-gps-spoofing-incident-response
...
This runbook governs emergency remediation procedures for: GPS Telemetry Spoofing & Tamper Incident Forensics.
