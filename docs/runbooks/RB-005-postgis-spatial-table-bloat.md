# Operational Runbook: PostGIS Vacuum and Spatial R-Tree Index Reindex Runbook
**Runbook Identifier**: RB-005-postgis-spatial-table-bloat
...
This runbook governs emergency remediation procedures for: PostGIS Vacuum and Spatial R-Tree Index Reindex Runbook.
