# ADR-002-dual-database-engine: Dual Storage Architecture with PostgreSQL PostGIS and SQLite Fallback

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Enables zero-setup local dev alongside cloud PostGIS.
...
## Decision Outcome
Chosen Option: **Dual Storage Architecture with PostgreSQL PostGIS and SQLite Fallback**.
