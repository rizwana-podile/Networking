# ADR-011-topology-graph-layout: SVG and Canvas Dynamic Force-Directed Network Topology Graph

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Interactive visualizer with dynamic latency-weighted links.
...
## Decision Outcome
Chosen Option: **SVG and Canvas Dynamic Force-Directed Network Topology Graph**.
