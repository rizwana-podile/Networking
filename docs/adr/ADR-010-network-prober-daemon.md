# ADR-010-network-prober-daemon: Background ICMP, TCP, HTTP and DNS Prober Architecture

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Non-blocking event loop probes for network node availability.
...
## Decision Outcome
Chosen Option: **Background ICMP, TCP, HTTP and DNS Prober Architecture**.
