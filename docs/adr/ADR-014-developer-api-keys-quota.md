# ADR-014-developer-api-keys-quota: SHA-256 Hashed Developer API Keys with Token-Bucket Rate Limiting

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Protects API endpoints with granular scopes and per-minute quotas.
...
## Decision Outcome
Chosen Option: **SHA-256 Hashed Developer API Keys with Token-Bucket Rate Limiting**.
