# ADR-020-docker-multi-stage-builds: Multi-Stage Docker Container Packaging with Alpine Linux

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Optimizes production container sizes and security boundaries.
...
## Decision Outcome
Chosen Option: **Multi-Stage Docker Container Packaging with Alpine Linux**.
