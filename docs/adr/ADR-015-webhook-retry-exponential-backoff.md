# ADR-015-webhook-retry-exponential-backoff: Webhook Delivery Pipeline with Exponential Backoff Retries

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Asynchronous HTTP webhook delivery with HMAC verification header.
...
## Decision Outcome
Chosen Option: **Webhook Delivery Pipeline with Exponential Backoff Retries**.
