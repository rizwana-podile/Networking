# ADR-022-redis-pubsub-scaling: Redis Pub/Sub Clustered Event Bus for Horizontal WebSocket Scaling

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Distributes location broadcasts across multiple API nodes.
...
## Decision Outcome
Chosen Option: **Redis Pub/Sub Clustered Event Bus for Horizontal WebSocket Scaling**.
