# ADR-024-netflow-ipfix-analysis: NetFlow v9 and IPFIX Flow Ingestion for Bandwidth Monitoring

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Aggregates packet conversations and top-talker protocols.
...
## Decision Outcome
Chosen Option: **NetFlow v9 and IPFIX Flow Ingestion for Bandwidth Monitoring**.
