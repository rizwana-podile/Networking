# ADR-005-hmac-gps-telemetry-verification: Cryptographic HMAC-SHA256 Signatures on GPS Ingestion

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Prevents telemetry tampering, spoofing, and MITM coordinate injection.
...
## Decision Outcome
Chosen Option: **Cryptographic HMAC-SHA256 Signatures on GPS Ingestion**.
