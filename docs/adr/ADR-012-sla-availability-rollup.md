# ADR-012-sla-availability-rollup: Sliding Window Rolling SLA Availability Calculations (24h/7d/30d)

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Calculates uptime percentages and SLA penalty compliance.
...
## Decision Outcome
Chosen Option: **Sliding Window Rolling SLA Availability Calculations (24h/7d/30d)**.
