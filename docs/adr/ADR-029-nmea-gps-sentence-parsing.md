# ADR-029-nmea-gps-sentence-parsing: NMEA-0183 GPRMC and GPGGA Satellite Sentence Telemetry Parser

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Direct hardware sentence parsing from vehicle telematics units.
...
## Decision Outcome
Chosen Option: **NMEA-0183 GPRMC and GPGGA Satellite Sentence Telemetry Parser**.
