# ADR-004-spatial-indexing-strategy: PostGIS R-Tree and GIST Spatial Indexing on Device Coordinates

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Optimizes bounding box and spatial proximity queries.
...
## Decision Outcome
Chosen Option: **PostGIS R-Tree and GIST Spatial Indexing on Device Coordinates**.
