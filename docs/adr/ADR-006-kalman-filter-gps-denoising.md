# ADR-006-kalman-filter-gps-denoising: Kalman Filter Algorithm for GPS Jitter and Velocity Smoothing

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Denoises raw satellite multipath errors and drift.
...
## Decision Outcome
Chosen Option: **Kalman Filter Algorithm for GPS Jitter and Velocity Smoothing**.
