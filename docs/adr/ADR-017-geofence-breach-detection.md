# ADR-017-geofence-breach-detection: Ray-Casting Point-in-Polygon Geofencing Engine

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Real-time boundary evaluation for circular and polygon zones.
...
## Decision Outcome
Chosen Option: **Ray-Casting Point-in-Polygon Geofencing Engine**.
