# ADR-021-database-partitioning: Timescale and Declarative Range Partitioning for High-Volume Telemetry

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Partitions location records by day to sustain millions of rows.
...
## Decision Outcome
Chosen Option: **Timescale and Declarative Range Partitioning for High-Volume Telemetry**.
