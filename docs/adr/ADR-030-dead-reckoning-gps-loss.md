# ADR-030-dead-reckoning-gps-loss: Dead Reckoning Gyroscope and Accelerometer Extrapolation

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Estimates vehicle position through tunnels and satellite blindspots.
...
## Decision Outcome
Chosen Option: **Dead Reckoning Gyroscope and Accelerometer Extrapolation**.
