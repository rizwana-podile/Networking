# ADR-025-bgp-route-flap-detection: BGP Peer State Tracking and Prefix Flap Mitigation Engine

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Alerts on routing table instability and peering drops.
...
## Decision Outcome
Chosen Option: **BGP Peer State Tracking and Prefix Flap Mitigation Engine**.
