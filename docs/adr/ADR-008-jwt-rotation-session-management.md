# ADR-008-jwt-rotation-session-management: Cryptographic HS256 JWT Token Rotation and Remote Session Revocation

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Implements 15-minute access tokens and 7-day refresh token rotation.
...
## Decision Outcome
Chosen Option: **Cryptographic HS256 JWT Token Rotation and Remote Session Revocation**.
