# ADR-018-time-series-percentiles: Nearest-Rank and Linear Interpolation Latency Percentile Computations

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Accurate p50, p90, p95, and p99 infrastructure response times.
...
## Decision Outcome
Chosen Option: **Nearest-Rank and Linear Interpolation Latency Percentile Computations**.
