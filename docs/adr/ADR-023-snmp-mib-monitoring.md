# ADR-023-snmp-mib-monitoring: SNMP v2c/v3 Telemetry Collection for Enterprise Switches and Routers

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Standardized OID polling for port traffic and CPU utilization.
...
## Decision Outcome
Chosen Option: **SNMP v2c/v3 Telemetry Collection for Enterprise Switches and Routers**.
