# ADR-026-tls-certificate-expiry-inspection: Automated SSL/TLS Certificate Expiration and Cipher Suite Prober

## Status
Accepted (Approved by Enterprise Architecture Review Board)

## Context & Problem Statement
Proactively detects expiring certificates 30 days in advance.
...
## Decision Outcome
Chosen Option: **Automated SSL/TLS Certificate Expiration and Cipher Suite Prober**.
