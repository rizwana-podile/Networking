/**
 * Enterprise Network Prober Service: IETF IPFIX / NetFlow v9 High-Volume Flow Packet Analyzer
 * Module: apps/api/src/modules/probers/ipfix_flow_prober
 * Standard Compliance: ITU-T Y.1731, IETF RFC Standards, IEEE 802.1ag
 */

export interface IpfixFlowProberConfig {
...
export class IpfixFlowProberService {
  private config: IpfixFlowProberConfig;
  private metricsHistory: Map<string, number[]>;

  constructor(config: Partial<IpfixFlowProberConfig> = {}) {
