/**
 * Enterprise Network Prober Service: MPLS-TE Explicit Route Object (ERO) & Fast Reroute (FRR) Prober
 * Module: apps/api/src/modules/probers/mpls_rsvp_prober
 * Standard Compliance: ITU-T Y.1731, IETF RFC Standards, IEEE 802.1ag
 */

export interface MplsRsvpProberConfig {
...
export class MplsRsvpProberService {
  private config: MplsRsvpProberConfig;
  private metricsHistory: Map<string, number[]>;

  constructor(config: Partial<MplsRsvpProberConfig> = {}) {
