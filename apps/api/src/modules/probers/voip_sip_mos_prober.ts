/**
 * Enterprise Network Prober Service: SIP Trunking Call Quality, RTP Jitter & PESQ/MOS Estimation
 * Module: apps/api/src/modules/probers/voip_sip_mos_prober
 * Standard Compliance: ITU-T Y.1731, IETF RFC Standards, IEEE 802.1ag
 */

export interface VoipSipMosProberConfig {
...
export class VoipSipMosProberService {
  private config: VoipSipMosProberConfig;
  private metricsHistory: Map<string, number[]>;

  constructor(config: Partial<VoipSipMosProberConfig> = {}) {
